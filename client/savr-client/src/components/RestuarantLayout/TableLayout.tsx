...
const TableLayout = ({
  ...
  const [startSize, setStartSize] = React.useState<{
    width: number;
    height: number;
  } | null>(null);
  ...
  }, [resizing, startPos, startSize, id, onResize]);
  ...
  const tableStyle: React.CSSProperties = {
    ...
    userSelect: 'none',
    transform:
      CSS.Translate.toString(finalTransform) + ` rotate(${rotation}deg)`,
    ...
    <>
      ...
      <div
        ...
        {!viewOnly && contextMenu && (
          <List
            onAddDetails={() => setClickedAddDetails(true)}
        ...
        <div
          ...
          {shape === 'Kitchen' && (
            <img
              alt="Kitchen"
              src={
                'https://www.shutterstock.com/image-vector/kitchen-icon-design-260nw-1066631165.jpg'
              }
              style={{
                position: 'absolute',
                top: 0,
          ...
          {shape === 'Patio' && (
            <img
              alt="Patio"
              src={
                'https://static.vecteezy.com/system/resources/previews/017/325/866/non_2x/bar-counter-table-icon-simple-cafe-pub-vector.jpg'
              }
              style={{
                position: 'absolute',
                top: 0,
